...
<head>
    ...
    <title>Animal Welfare | SignUp</title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        ...
        <a class="nav-link active" aria-current="page" style="color: #fff;" href="vetnary.html">Care Takers</a>
        <a class="nav-link active" aria-current="page" style="color: #fff;" href="#">Shop</a>
